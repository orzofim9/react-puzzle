  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <img src="./image.jpg" className="im" id="500" width="250" height="320"   /*draggable = "true"*/ />   
         ...
         {arr.map(tile => <CroppedPhoto img_path="./image.jpg" startpxX={tile.xpos} startpxY={tile.ypos} gridSize={gridSize} idNum={tile.numName}/>)}
          </div>
